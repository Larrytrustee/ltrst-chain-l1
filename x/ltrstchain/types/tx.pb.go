...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_3277933a10e204e3, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3277933a10e204e3, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "ltrstchain.ltrstchain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "ltrstchain.ltrstchain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("ltrstchain/ltrstchain/tx.proto", fileDescriptor_3277933a10e204e3) }

var fileDescriptor_3277933a10e204e3 = []byte{
	// 320 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcb, 0x29, 0x29, 0x2a,
	0x2e, 0x49, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x47, 0x62, 0x96, 0x54, 0xe8, 0x15, 0x14, 0xe5, 0x97,
	...
	0x35, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xaa, 0x83, 0x57, 0xee, 0x54, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ltrstchain.ltrstchain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ltrstchain.ltrstchain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ltrstchain.ltrstchain.Msg",
	...
	Metadata: "ltrstchain/ltrstchain/tx.proto",
}
